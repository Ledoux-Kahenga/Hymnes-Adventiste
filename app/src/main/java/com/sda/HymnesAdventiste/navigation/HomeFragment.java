...
//import com.sda.HymnesAdventiste.chant.favoris.HymneFav;
import com.sda.HymnesAdventiste.chant.favoris.HymneFav;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((ImageView) root.findViewById(R.id.hymneFave)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                HomeFragment.this.startActivity(new Intent(HomeFragment.this.getActivity(), HymneFav.class));
                Animatoo.animateSlideRight(HomeFragment.this.getContext());
            }
        });
