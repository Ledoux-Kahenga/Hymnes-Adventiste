...
public class FavNyimboAdapteur extends RecyclerView.Adapter<FavNyimboAdapteur.ViewHolder>{
...
//    }
    ...
    public FavNyimboAdapteur(Context context, List<Model> mainModels) {
        this.context = context;
    ...
    @NonNull
    @Override
    public FavNyimboAdapteur.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavNyimboAdapteur.ViewHolder holder, int position) {
