...
public class PagerNyimbo extends PagerAdapter {
    ...
    public PagerNyimbo(Context context, List<Model> models) {
...
//        AudioPlay audioC = new AudioPlay(position);
        ...
        titleSwali.setText(Html.fromHtml(models.get(position).getTitleSwahili()));
        ...
        midi = models.get(position).getLyricAudio();
