//package com.sda.projet.chant.model.adapteurs.recyclerview;
//
...
//import com.sda.projet.HynesActivity;
//import com.sda.projet.MainModel;
//import com.sda.projet.R;
//
//public class HymnesAdapteur extends FirebaseRecyclerAdapter<MainModel, HymnesAdapteur.myViewHolder> {
//
//    Context context;
//
//    public HymnesAdapteur(@NonNull FirebaseRecyclerOptions<MainModel> options) {
//        super(options);
//    }
//
//
//
//    @Override
//    protected void onBindViewHolder(@NonNull HymnesAdapteur.myViewHolder holder, int position, @NonNull MainModel model) {
...
////                Intent gh = new Intent(context, HynesActivity.class);
////                gh.putExtra("pos",1);
////            }
////        });
//
